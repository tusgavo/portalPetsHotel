...
<head>
    ...
    <link rel="stylesheet" href="./assets/styles/stylesHome.css">
</head>
    ...
    <header class="cabecalhoPrincipal">
        <div class="container">
            <h1 class="cabecalhoPrincipal-titulo">
                <a href="index.php"><img src="./assets/images/logo.png" width="200px" alt=""></a>
            </h1>
            <nav class="cabecalhoPrincipal-nav">
                ...
                <a class="cabecalhoPrincipal-nav-link" href="http://petshotel.herokuapp.com/login">App</a>
            </nav>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="http://petshotel.herokuapp.com/login">App</a></li>
                </ul>
            </div>
        </div>
        ...
        <hr class="hr">
        <center>
            <h1 class="textoPrin">Portal PetsHotel</h1>
            <h5 class="subtituloPrin">Tudo pro seu Pet!</h5>
        </center>
        <hr class="hr">
    </header>